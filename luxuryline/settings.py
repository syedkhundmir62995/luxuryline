"""
Django settings for luxuryline project.
...
SECRET_KEY = 'django-insecure-uped1yxptm-#1mtod+ef59j$hxx2wmy+_$x5e#wm8j5@(t@dbp'
...
ROOT_URLCONF = 'luxuryline.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR,'luxuryline/templates'),
...
WSGI_APPLICATION = 'luxuryline.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR,'luxuryline/static'),
